...
def image_bigrams_all_directions(image: np.array, outside_value: int) -> list[Tuple[int, int]]:
    """
    Extract all bigrams.
    """
    bigram_list = []
    ...
    # swap the tupple values, so the smallest value comes first, and the largest comes last
