...
def generate_dataset_item(seed):
    ...
    image0 = image_create_random_advanced(seed + 1006, min_image_size, max_image_size, 1, 6)
    image1 = image_create_random_advanced(seed + 1007, min_image_size, max_image_size, 1, 6)
