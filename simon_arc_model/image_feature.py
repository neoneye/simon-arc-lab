...
class ImageFeature(Enum):
    ...
    GRAVITY_MOVE_TOP_TO_BOTTOM = 'gravity_move_top_to_bottom'
    GRAVITY_MOVE_BOTTOM_TO_TOP = 'gravity_move_bottom_to_top'
    GRAVITY_MOVE_LEFT_TO_RIGHT = 'gravity_move_left_to_right'
    GRAVITY_MOVE_RIGHT_TO_LEFT = 'gravity_move_right_to_left'
    GRAVITY_MOVE_TOPLEFT_TO_BOTTOMRIGHT = 'gravity_move_topleft_to_bottomright'
    GRAVITY_MOVE_BOTTOMRIGHT_TO_TOPLEFT = 'gravity_move_bottomright_to_topleft'
    GRAVITY_MOVE_TOPRIGHT_TO_BOTTOMLEFT = 'gravity_move_topright_to_bottomleft'
    GRAVITY_MOVE_BOTTOMLEFT_TO_TOPRIGHT = 'gravity_move_bottomleft_to_topright'
