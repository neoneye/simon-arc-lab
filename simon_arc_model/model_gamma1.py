...
class ModelGamma1:
    ...
    def supported_features(cls) -> set[ImageFeature]:
        ...
        return {
            ...
            ImageFeature.GRAVITY_MOVE_BOTTOM_TO_TOP,
            ImageFeature.GRAVITY_MOVE_BOTTOMLEFT_TO_TOPRIGHT,
            ImageFeature.GRAVITY_MOVE_BOTTOMRIGHT_TO_TOPLEFT,
            ImageFeature.GRAVITY_MOVE_LEFT_TO_RIGHT,
            ImageFeature.GRAVITY_MOVE_RIGHT_TO_LEFT,
            ImageFeature.GRAVITY_MOVE_TOP_TO_BOTTOM,
            ImageFeature.GRAVITY_MOVE_TOPLEFT_TO_BOTTOMRIGHT,
            ImageFeature.GRAVITY_MOVE_TOPRIGHT_TO_BOTTOMLEFT,
